 ...
 *    - Added CompanyRecruiters junction table with permissionLevel field
 *    - Added createdByRecruiterId to Companies table
 * 
 * 3. Permission Levels in CompanyRecruiters:
 *    - owner: Full control over company and jobs (original creator)
 *    - shared-owner: Can edit company details and jobs (added collaborator with high privileges)
 *    - shared: View-only access to company and jobs (limited collaborator)
 * 
